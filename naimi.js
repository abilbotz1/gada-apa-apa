...
mediaType:1,
mediaUrl: 'https://www.instagram.com/rielxd_4',
sourceUrl: "https://www.instagram.com/rielxd_4"}}}, { quoted: m })
}
try {
...
*Terimakasih telah mendapatkan diri ke database Khurushi berikut adalah infonya*\n\n*●Nama : ${pushname}*\n*●Nomor : ${sender.split('@')[0]}*\n*●Pengguna : ${register.length}*\n*●SN : ${serialUser}*\n\n*Gunakan bot sewajarnya*`
...
url: 'https://instagram.com/rielxd_4'
}
}, {
quickReplyButton: {
displayText: 'MENU',
...
listMessage :{
    ...
    buttonText: "Menu",
    footerText: `*© Powered by khurushi*`,
...
naimi.sendMessage(m.chat, { image: { url: anu }, caption: `*© Powered by khurushi*\n\nJangan lupa donet :)` }, { quoted: m })
 }
break
case '3dbox':
  if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted:ftex})
...
maker.textpro("https://textpro.me/3d-box-text-effect-online-880.html", [
    `${q}`,])
.then((data) => naimi.sendMessage(m.chat, { image: { url: data }, caption: `*© Powered by khurushi*\n\nJangan lupa donet :)` }, { quoted: m }))
...
naimi.sendMessage(from, {video:{url:i.url}, caption:`Type : ${i.type}`, mimetype:'video/mp4'}, {quoted:m})
  ...
  try {
    reply(mess.wait)
  naimi.sendMessage(from, {image:{url:args[0]}, caption:' © Powered by khurushi'}, {quoted:m})
  } catch {
reply("Linknya Error")
}
break
...
quickReplyButton: {
displayText: '🤖ᴀʟʟ ᴄᴏᴍᴍᴀᴅ🤖',
id: 'allmenu'
}  
}, {
quickReplyButton: {
displayText: '🗿ᴄᴀʀɪ ᴛᴇᴍᴀɴ ᴋᴀʟᴏ ᴀᴅᴀ🗿',
id: 'ac'
}
}]
setbot = db.settings[botNumber]
